...
**Plugin for <a href="https://github.com/sapphire-community/framework">@sapphire/framework</a> to expose a REST API.**
...
For the full API documentation please refer to the TypeDoc generated [documentation](https://sapphire-community.github.io/plugins/modules/_sapphire_plugin_api.html).
