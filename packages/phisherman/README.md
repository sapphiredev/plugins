...
[![npm bundle size](https://img.shields.io/bundlephobia/min/@sapphire/plugin-phisherman?logo=webpack&style=flat-square)](https://bundlephobia.com/result?p=@sapphire/plugin-phisherman)
[![npm](https://img.shields.io/npm/v/@sapphire/plugin-phisherman?color=crimson&logo=npm&style=flat-square)](https://www.npmjs.com/package/@sapphire/plugin-phisherman)
...
`@sapphire/plugin-phisherman` depends on the following packages. Be sure to install these along with this package!
...
```sh
npm install @sapphire/plugin-phisherman @sapphire/framework
```
